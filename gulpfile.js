...
var conn = ftp.create({
    host: 'waws-prod-db3-035.ftp.azurewebsites.windows.net',
    user: 'accenture-techtracker\$accenture-techtracker',
    password: 'Lpelpo0YErMyh7fJK61gwDdj5QLKKgNX5gQXdBsvnecd7869mDEGNebo9Gqt',
    parallel: 1,
    log: function(){
